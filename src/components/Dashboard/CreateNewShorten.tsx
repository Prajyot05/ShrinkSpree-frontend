...
const CreateNewShorten: React.FC<CreateNewShortenProps> = ({ setOpen }) => {
  ...
  const createShortUrlHandler = async (data: FormData) => {
    setLoading(true);
    try {
      ...
      const shortenUrl = `${import.meta.env.VITE_REACT_FRONT_END_URL}/s/${
        res.shortUrl
      }`;
